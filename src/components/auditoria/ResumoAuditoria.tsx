...
export type FiltroAuditoria = "todos" | "beneficio" | "tributado" | "invalido" | "divergencias";
...
export function ResumoAuditoria({ resumo, filtro, onFiltrar }: ResumoAuditoriaProps) {
  return (
    <div role="group" aria-label="Resumo da auditoria" className="grid grid-cols-2 gap-3 md:grid-cols-5">

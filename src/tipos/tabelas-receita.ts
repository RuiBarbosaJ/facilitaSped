/**
 * Uma linha das tabelas 4.3.x da Receita: o NCM, o CST que ele admite e a
 * natureza da receita.
 *
 * NÃO confundir com `RegistroSped` de `regras/nucleo/tipos.ts`, que é um
 * registro do ARQUIVO SPED (0000, C100, C170). São coisas diferentes com o
 * mesmo nome — daí este chamar-se regra de tabela, e não registro.
 */
export interface RegraTabelaSped {
  ncm: string;
  descricao: string;
  cst: string;
  aliquota: string;

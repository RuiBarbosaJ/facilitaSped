...
/*
 * As duas auditorias são nomeadas pela obrigação que atendem, não pelo que
 * fazem por dentro. "Auditoria" e "SPED ICMS" lado a lado sugeriam uma seção
 * guarda-chuva e um caso à parte; nomeadas pelo tributo, leem-se como o par que
 * são — e a navegação passa a mostrar de cara o alcance da ferramenta.
 */
const PAGINAS = [
  { href: "/", rotulo: "Consulta" },
  { href: "/pis-cofins", rotulo: "PIS/COFINS" },
  { href: "/icms-ipi", rotulo: "ICMS/IPI" },
] as const;

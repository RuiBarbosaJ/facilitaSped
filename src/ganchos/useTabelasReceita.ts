 ...
 */
function ehRegistroSped(valor: unknown): valor is RegraTabelaSped {
...
export function useTabelasReceita(): EstadoRegistros {
  const [registros, setRegistros] = useState<RegraTabelaSped[]>([]);

 ...
 */
const ehDefinicaoDeCst = (registro: RegraTabelaSped): boolean =>
...
const chaveRegra = (registro: RegraTabelaSped): string =>
 ...
 */
export function apenasVigenciaMaisRecente(registros: RegraTabelaSped[]): RegraTabelaSped[] {
...
export function useFiltroCst(
  ...
  cst: string
): { opcoes: OpcaoCst[]; regras: RegraTabelaSped[] } {
